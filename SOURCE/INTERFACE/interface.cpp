 ...
 *
 */
Interface::Interface(void):applicationInterface(SYSCONFIG->getParam<QString>(SYS_COLLIMATOR_PROCESS_PARAM,SYS_PROCESS_IP),SYSCONFIG->getParam<int>(SYS_COLLIMATOR_PROCESS_PARAM,SYS_PROCESS_PORT))
{
